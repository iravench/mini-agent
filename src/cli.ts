...
function printBanner() {
	...
	console.log(chalk.cyan("  ║") + chalk.bold("  mini-agent  ") + chalk.dim("v0.1.0") + chalk.dim("                ║"));
	console.log(chalk.cyan("  ║") + chalk.dim("  Kimi K2 · Moonshot AI              ║"));
	console.log(chalk.cyan("  ╚══════════════════════════════════════╝"));
	console.log();
...
async function main() {
	...
	if (!apiKey) {
		console.error(chalk.red("Error: MOONSHOT_API_KEY environment variable not set."));
